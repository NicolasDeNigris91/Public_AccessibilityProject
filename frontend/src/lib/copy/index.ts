export const copy = {
  ...
  auth: {
    signinTitle: "Entrar no Euthus",
    signinLead: "Enviamos um link mágico pro seu email — sem senha, sem cadastro.",
    emailLabel: "Seu email",
    emailPlaceholder: "voce@exemplo.com",
    submitButton: "Enviar link mágico",
    submittingButton: "Enviando…",
    checkInboxTitle: "Verifique seu email",
    checkInboxLead: "Mandamos um link pra entrar. Ele expira em 15 minutos.",
    checkInboxRetry: "Não recebeu? Tentar de novo",
    verifyingTitle: "Entrando…",
    verifyingLead: "Validando seu link mágico.",
    errorEmailInvalid: "Email inválido. Confira a digitação.",
    errorRateLimited: "Muitos pedidos em pouco tempo. Aguarde alguns minutos.",
    errorEmailNotConfigured: "O servidor não está configurado pra enviar emails neste ambiente.",
    errorVerifyExpired: "Este link expirou. Peça um novo abaixo.",
    errorVerifyUsed: "Este link já foi usado. Peça um novo se precisar.",
    errorVerifyInvalid: "Link inválido. Peça um novo.",
